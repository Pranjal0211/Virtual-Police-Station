        ...
        <>
            <div className="relative slider-div">
                ...
                <div className="slider">
                    <figure className="figure md:h-screen bg-gray-800">
                        <div className="slide"><img className="" src={img1} alt="" /></div>
                        <div className="slide"><img className="" src={img2} alt="" /></div>
                        <div className="slide"><img className="" src={img3} alt="" /></div>
                        <div className="slide"><img className="" src={img4} alt="" /></div>
                    </figure>
                </div>
            </div>
        </>
